package com.tbc.mini.support.service.base;

import com.tbc.mini.common.utils.SpringContextUtil;
...
public abstract class BaseServiceImpl<Mapper, Record, Example> implements BaseService<Record, Example> {
    ...
    @Override
    public int deleteByPrimaryKeys(String ids, Class idClass) {
        try {
            ...
            for (String idStr : idArray) {
                ...
                Method deleteByPrimaryKey = mapper.getClass().getDeclaredMethod("deleteByPrimaryKey", idClass);
                Object result;
                if ("Integer".equals(idClass.getSimpleName())) {
                    result = deleteByPrimaryKey.invoke(mapper, Integer.parseInt(idStr));
                } else {
                    result = deleteByPrimaryKey.invoke(mapper, Long.parseLong(idStr));
                }
