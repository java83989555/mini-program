package com.tbc.mini.support.service.listener;


import com.tbc.mini.support.service.base.BaseInterface;
...
public class ApplicationContextListener implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        ...
        if (null == contextRefreshedEvent.getApplicationContext().getParent()) {
            logger.warn(">>>>> spring inited  {} <<<<<", Arrays.toString(environment.getActiveProfiles()));
            // spring初始化完毕后，通过反射调用所有使用BaseService注解的initMapper方法
            Map<String, Object> baseServices = contextRefreshedEvent.getApplicationContext().getBeansWithAnnotation(com.tbc.mini.support.service.annotation.BaseService.class);
    ...
    public ApplicationContextListener(Environment environment) {
