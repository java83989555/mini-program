...
function guide() {
	...
	$("#show4").click(function() {
		$("#show4").addClass("hide");
		$("#show5").removeClass("hide")
	})
	$("#show5").click(function() {
		$("#show5").addClass("hide");
		$("#show6").removeClass("hide")
	})
...
function getWarningNums(){

	$.ajax({
		url: "/notice/warning/getNoticeNums",
		success: function (res) {
			if(window.parent.document.getElementById("tipNumElmIn")==null){
				if(window.parent.document.getElementById("tipNumElm") != null){
					window.parent.document.getElementById("tipNumElm").classList.add("hide");
				}
			}else{
				window.parent.document.getElementById("tipNumElm").innerHTML = res.data;
				window.parent.document.getElementById("tipNumElmIn").innerHTML = res.data;
			}
...
$(function() {
	...
	$.ajax({
		...
		dataType: "json",
		success: function(data, textStatus, jqXHR) {
			$('#js_main_version').html(data.data.systemVersion);
		}
	});
